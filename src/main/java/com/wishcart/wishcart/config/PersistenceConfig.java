...
public class PersistenceConfig {
    ...
    static abstract class AbstractJpaConfig{
        ...
        public AbstractJpaConfig(WishCartProperties wishCartProperties, JpaProperties jpaProperties, DataSource dataSource){
        ...
        protected LocalContainerEntityManagerFactoryBean buildEntityManagerFactory(EntityManagerFactoryBuilder builder,
                                                                                   String unitName, String schemaName,
            ...
            return builder.dataSource(getDataSource())
                    ...
                    .packages(packagesToScan.toArray(new Class<?>[]{}))
                    .properties(getHibernateProperties(SCHEMA_NAME))
                    .build();
        }
    }
}
